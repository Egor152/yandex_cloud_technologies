...
class AppConfig:
    CERTIFICATE_PATH = '/crt/Скрыл по просьбе Яндекс Практикума'
    ...
    def __init__(self) -> None:
        ...
        self.pg_warehouse_port = int(os.getenv('PG_WAREHOUSE_PORT', 'Скрыл по просьбе Яндекс Практикума')) if os.getenv('PG_WAREHOUSE_PORT') is None else int(os.getenv('PG_WAREHOUSE_PORT'))
